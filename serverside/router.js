...
router.route("/declinebooking").delete(prod.declineBooking);
router.route("/acceptbooking").delete(prod.acceptBooking);
router.route("/getorders/:buyerId").get(prod.getOrders);
