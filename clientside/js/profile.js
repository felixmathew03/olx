...
async function getUser() {
    ...
    document.getElementById("orders").innerHTML=`<a href="../pages/orders.html?id=${user._id}">MY ORDERS </a>`;
}
getUser();
...
async function getSProducts() {
    ...
    document.getElementById("bookings").innerHTML=`<a href="../pages/sellerbookings.html?id=${id}">BOOKINGS <span id=count>(${result.count})<span></a>`;
